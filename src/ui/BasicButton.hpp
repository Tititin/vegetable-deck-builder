...
class BasicButton : public Clickable {
    ...
    public:
        ...
        void setPosition(const sf::Vector2f& position) { _buttonShape.setPosition(position); }
        void setSize(const sf::Vector2f& size) { _buttonShape.setSize(size); }
        void setFillColor(const sf::Color& color) { _buttonShape.setFillColor(color); }
